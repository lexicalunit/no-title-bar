...
const dockWorkaroundElements = [null, null]
const dockWorkaroundObservers = [null, null]
const dockWorkaroundTimeout = [null, null]
...
function adjustDockWorkaroundElement (side) {
  ...
  dockWorkaroundTimeout[pos] = setTimeout(() => {
    const element = dockWorkaroundElements[pos]
    if (element) {
      __guard__(document.querySelector([
