...
function setupDockWorkaround (side) {
  __guard__(document.querySelector([
    ...
    // dock contents from interferring with dragging. However, scrolling in the
    // editor's tab-bar can also interfer. So we must put our workaround
    ...
    dockWorkaroundElements[pos].style.backgroundColor = 'red'
